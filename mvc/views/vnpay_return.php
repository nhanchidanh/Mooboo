...
<body class="d-flex flex-column align-items-center justify-content-between" style="height:100vh">
                ...
                <label>
                    ...
                    if ($secureHash == $vnp_SecureHash) {
                        if ($_GET['vnp_ResponseCode'] == '00') {
                            echo "<span class='success_vnpay' style='color:blue; cursor: pointer;'>Xác nhận GD Thanh cong</span>";
                        } else {
    ...
    <script src="<?php echo _PUBLIC_PATH . '/client/assets/js/checkout.js' ?>"></script>
</body>
